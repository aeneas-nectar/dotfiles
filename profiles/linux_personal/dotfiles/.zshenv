...
export PATH="$DOTFILES_EXPORT:${CURL_EXPORT}:$LOCAL_BIN_EXPORT:$LOCAL_SHARE_EXPORT:$LOCAL_SBIN_EXPORT:$USR_BIN_EXPORT:$USR_SBIN_EXPORT:$ROOT_BIN_EXPORT:$ROOT_SBIN_EXPORT:${N_BIN_EXPORT}"
